...
\author{B{\aa}rd Hennning Tvedt\corref{cor3}}
\ead{Bard.Tvedt@student.uib.no}
...
% \bibitem{cormen90} % Removed in revision
% Cormen, T. H., Leiserson, C. E., Rivest, R. L,
% Introduction to Algorithms, 
% MIT Press, 401 -- 402, 1990. 

\bibitem{dobrian19} % New in revision
...
\bibitem{fraigniaud94} % New in revision
...
\bibitem{harutyunyan13} % New in revision
...
\bibitem{harutyunyan10} % New in revision
...
\bibitem{hedetniemi88} % New in revision
...
\bibitem{hopcroft73} % New in revision
...
\bibitem{hromkovic96} % New in revision
...
% \bibitem{jakoby92} % New in revision
% Jakoby, A., Reischuk, R., Schindelhauer, C.,
% Minimum Broadcast Time auf Graphen mit konstantern Grad,
% 18. Workshop i\&r Komplexitltstheorie und effiziente Algorithmen,
% Forschungsbericht 92--17, Universitlt Trier (1992).
...
10.6084/M9.FIGSHARE.1164194.V13, (2014)


\bibitem{ravi94} % New in revision
Ravi, R.,
...
% \bibitem{jimborean13} % Removed in revision
% Jimborean, C.,
